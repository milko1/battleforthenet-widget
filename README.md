...
<script type="text/javascript">
  var _bftn_options = {
    /*
      This is using ipdata.io free tier allowing 1500 calls per day, exceeding this limit will produce an 429 http error from them,
      which is handled gracefully & logged in console & will not show popup (assumes is the wrong country),
